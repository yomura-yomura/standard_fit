...
def add_function(fit_type: str, func, initial_guess_func=None):
    ...
    setattr(functions.custom.initial_guess, fit_type, initial_guess_func)
    setattr(functions.custom.functions, fit_type, func)
    functions.custom.__all__.append(fit_type)
